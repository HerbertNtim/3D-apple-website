...
const Model = () => {
  ...
  // keeping track of the model to access its properties when animating
  // model
  ...
  return (
    <section className='common-padding'>
      <div className='screen-max-width'>
        ...
        {/* creating the 3D model container and content*/}
        <div className='flex flex-col items-center mt-5'>
          <div className='w-full h-[75vh] md:h-[90vh] overflow-hidden'>
            ...
            >
              <View.Port /> // rendering multiple models in the same canvas
            </Canvas>
          </div>
